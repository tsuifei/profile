...
<p>MISSION : Identité visuelle et logotype, Supports de communication print : cartes de visite, papier en-tête et produits dérivés.</p>
  ...
  <p>MISSION : Création graphique, Charte graphique, Photographie, Emballages et Visuelle digitale.</p>
  <div class="img__wrap">
...
<!-- Création graphique, Charte graphique et Visuelle digitale  -->
  </div>
</template>
...
@import "~@/assets/css/base";
  ...
  /*  transition: opacity 1s, visibility 1s, height .5s; */
    
  }

  .img__web:hover .img__description,
  .img__logo:hover .img__description,
  .img__pub:hover .img__description {
    visibility: visible;
    opacity: .9;
    height: 30%;
  }
